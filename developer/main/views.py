...
def demand1(request):
    ...
    class DataSet:
        ...
        def get_statistic(self):
            ...
            stats4 = dict(stats4)
            stats3 = list(
                filter(lambda a: a[0] in list(stats4.keys()), [(key, value) for key, value in stats3.items()]))
    ...
    class InputConnect:
        def __init__(self):
            ...
            self.vacancy_name = 'Android разработчик'
        ...
        def generate_pdf(self):
            ...
            pdf_template = template.render({'name': self.vacancy_name,
                                            'path': '{0}/{1}'.format(pathlib.Path(__file__).parent.resolve(),
                                                                     'graph.png'), 'stats': stats,
                                            'stats5': self.stats5, 'stats6': self.stats6})
